...
namespace EstarDXBase.Domain.Data.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<EFDbContext>
    {
        ...
        protected override void Seed(EFDbContext context)
        {
            ...
            DbSet<EduType> EduTypeSet = context.Set<EduType>();
            EduTypeSet.AddOrUpdate(t => new { t.Id }, EduTypes.ToArray());
            context.SaveChanges();

            //组织机构
            var SystemOragnizaitons = new List<SystemOragnization> { 

                    new SystemOragnization{
                        Id=1,
                        Name="辽宁省教育厅",
                        ParentID=0,
                        LayerFlag="1",
            ...
            DbSet<SystemOragnization> SystemOragnizationSet = context.Set<SystemOragnization>();
            SystemOragnizationSet.AddOrUpdate(t => new { t.Id }, SystemOragnizaitons.ToArray());
            context.SaveChanges();
